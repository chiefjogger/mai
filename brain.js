...
const PACK_MONEY = [
  ...
  },
  {
    ...
    reply: "Na đi dã ngoại Cần Giờ 08/08, trường xin đơn đồng ý và 120.000đ trước hôm đó. Mai điền sẵn đơn rồi, chỉ chờ anh ký.",
  ...
  },
  {
    ...
    w: 2,
    reply: "120.000đ, nộp cùng đơn trước 08/08. Mai chuyển luôn lúc anh ký thì có biên lai gửi cô Hồng, khỏi để Na cầm tiền mặt.",
    src: "email THCS Trần Phú",
    flow: "form",
  ...
  },
  {
    ...
    w: 2,
    reply: "Trước 08/08, tức còn hai ngày. Email trường gửi từ 03/08, Mai giữ lại chờ anh rảnh.",
    src: "email THCS Trần Phú",
    flow: "form",
    cta: "Ký đơn ngay",
  ...
  },
  {
    ...
    w: 3,
    reply: "Trả cả 850.000đ học bơi và 120.000đ dã ngoại thì ví còn 1.510.000đ. Vẫn dư cho giỗ Ông 09/08.",
    src: "ví WinMoney",
    flow: "pay",
  ...
  },
  {
    ...
    w: 2,
    reply: "Hai khoản, tổng 970.000đ: học bơi 850.000đ hạn 17:00 hôm nay và dã ngoại của Na 120.000đ hạn 08/08. Ngoài hai cái đó tuần này không còn gì.",
    src: "hồ sơ nhà mình",
    flow: "pay",
  ...
  },
  {
    ...
    w: 3,
    reply: "Đang mở: học bơi Bin 850.000đ hạn hôm nay, dã ngoại Na 120.000đ hạn 08/08, đăng kiểm xe khoảng 340.000đ ngày 12/08. Đã xong: học phí quý 3 và điện tháng 7.",
    src: "hồ sơ nhà mình",
    files: true,
  ...
  },
  {
    ...
    w: 2,
    reply: "Trước cuối tuần chỉ còn đơn và 120.000đ dã ngoại của Na, hạn 08/08. Thứ Bảy là giỗ Ông, khoản đó Mai để riêng chưa tính vào đây.",
    src: "hồ sơ nhà mình",
    flow: "form",
    cta: "Ký đơn cho Na",
...
const PACK_KIDS = [
  ...
  },
  {
    ...
    must: ["boi"],
    w: 2,
    reply: "Buổi tới là chiều mai 07/08, đã dời sang 17:00 vì lớp 3A nghỉ. Tuần sau về lại bình thường, thứ Ba và thứ Năm 16:30.",
  ...
  },
  {
    ...
    reply: "Chiều mai lớp 3A nghỉ vì giáo viên họp, cô Lan báo lúc 15:44. Mai đã dời buổi bơi 07/08 sang 17:00 và báo Vy rồi.",
  ...
  // ————— Na —————
  {
    ...
    not: ["bin"],
    reply: "Họp phụ huynh của Na lúc 19:00 15/08, phòng A2, cô Hồng chủ nhiệm 6A2. Đã vào lịch anh và Vy, nhắc trước một ngày.",
  ...
  // ————— giỗ Ông & quà cho Bà —————
  {
    ...
    reply: "Giỗ Ông 09/08 ở nhà Ông Bà, Bà đã nhắn cả nhà về ăn giỗ. Cô Út đặt xe rồi.",
    src: "Ông bà & cô chú",
    goto: "ongba",
    cta: "Mở nhóm Ông bà",
    chips: ["Mua quà gì cho Bà?", "Tuần này có gì?", "Tối 08/08 tôi rảnh không?"],
  },
  ...
  },
  {
    ...
    reply: "Chiều 07/08 lớp 3A nghỉ nên buổi bơi dời sang 17:00, Mai đã báo Vy. Tối 07/08 Mai nhắc anh soạn balo cho Na đi Cần Giờ.",
    src: "lịch nhà mình",
  ...
  },
  {
    ...
    reply: "Ngày 07/08 Bin bơi 17:00, 08/08 Na đi Cần Giờ và 20:00 mở bán vé đợt 3, 09/08 giỗ Ông. Họp phụ huynh Na thì 15/08.",
    src: "lịch nhà mình",
    chips: ["Tối 08/08 tôi rảnh không?", "Giỗ Ông hôm nào?", "Đơn dã ngoại của Na ký chưa?"],
  },
  {
    ...
    k: ["thu sau toi ranh khong", "toi thu sau co gi", "thu sau toi ban khong", "toi ranh thu sau khong", "thu sau co gi", "toi thu sau ranh", "toi thu sau the nao",
        ...
        "toi 08 08 toi ranh khong", "toi 08 08 ranh khong", "toi 08 08 co gi", "08 08 toi ranh khong"],
    must: ["thu sau", "08 08", "0808"],
    reply: "Tối 08/08 lịch anh trống, chỉ có 20:00 mở bán vé đợt 3 Anh Trai Say Hi. Mai canh giùm để anh khỏi ngồi bấm.",
    src: "lịch của anh",
    flow: "ticket",
    cta: "Để Mai canh vé",
...
const PACK_DOCS = [
  // ————— ĐĂNG KIỂM · rộng → cụ thể —————
  {
    ...
    not: ["bao hiem", "tnds"],
    reply: "Đăng kiểm xe 51K-238.19 hết hạn 12/09, còn 37 ngày. Mai giữ được 07:30 sáng 12/08, khung vắng nhất trong tuần.",
    src: "hồ sơ xe",
    flow: "inspect",
  ...
  },
  {
    ...
    w: 2,
    reply: "Mai đặt 07:30 12/08 ở trung tâm 50-07V Bình Thạnh, xong trước cuộc họp 10:00 của anh.",
    src: "lịch của anh",
    flow: "inspect",
    cta: "Đặt lịch",
  ...
  },
  {
    ...
    reply: "Đi 07:30 ngày 12/08 thì khoảng 20 phút là xong, chú Bình tuần trước vào 7:20 ra 7:45. Anh vẫn kịp cuộc họp 10:00.",
    src: "kênh Vietnam Cars",
    flow: "inspect",
    cta: "Đặt 07:30 ngày 12/08",
...
const PACK_SHOP = [
  ...
  // ————— quà cho Bà —————
  {
    ...
    w: 2,
    reply: "Hộp quà trà sen Phúc Long 165.000đ, đúng loại Bà hay uống. Đặt hôm nay thì Supra giao 08/08, kịp giỗ Ông 09/08.",
    src: "hồ sơ nhà mình",
    cta: "Mua hộp trà",
    action: { label: "Mua 165.000đ", amount: 165000 },
    chips: ["Giỗ Ông 09/08 chuẩn bị gì?", "Số dư WinMoney còn bao nhiêu?", "Supra giao lúc mấy giờ?"],
  },
  {
    id: "shop_tea_price",
    ...
    cta: "Mua hộp trà",
    action: { label: "Mua 165.000đ", amount: 165000 },
    chips: ["Giỗ Ông 09/08 chuẩn bị gì?", "Đơn này được bao nhiêu điểm WinX?", "Số dư WinMoney còn bao nhiêu?"],
  },
];
...
const PACK_LIFE = [
  ...
  },
  {
    ...
    chips: ["Trả học bơi cho Bin", "Đặt lịch đăng kiểm xe", "Mai canh vé giúp anh lúc 20:00 ngày 08/08"],
  },
  {
    id: "mai_vs_assistant",
  ...
  },
  {
    ...
    reply: "15:42 chiều nay, ngày 06/08. Còn 48 phút nữa Bin tan lớp bơi và 1 tiếng 18 phút tới hạn đóng học phí.",
  ...
  // ————— VÉ ĐỢT 3 —————
  {
    ...
    w: 2,
    reply: "Đợt 3 mở 20:00 08/08, khu B còn nhiều, mỗi CCCD tối đa 4 vé. Đợt 2 hết trong 7 phút nên anh để Mai canh sẵn thì chắc hơn.",
    src: "kênh Anh Trai Say Hi",
    flow: "ticket",
    cta: "Để Mai canh vé",
  ...
  },
  {
    ...
    flow: "ticket",
    cta: "Chọn vé",
    chips: ["Mai canh vé giúp anh lúc 20:00 ngày 08/08", "Mua vé lại có bị lừa không?", "Số dư WinMoney còn bao nhiêu?"],
  },
  {
    id: "ticket_queue",
...
export const FALLBACKS = [
  ...
  },
  {
    ...
    chips: ["Đặt lịch đăng kiểm xe", "Mai canh vé giúp anh lúc 20:00 ngày 08/08", "Đặt giỏ WinMart+ tối nay"],
  },
  {
...
const PACK_GAPS = [
  ...
  },
  {
    ...
    must: ["nghi", "mai"],
    w: 2,
    reply: "Chiều mai lớp nghỉ, cô Lan báo giáo viên họp. Mai dời buổi bơi của Bin sang 07/08 lúc 17:00 và đã nhắn Vy.",
...
const PACK_GAPS2 = [
  ...
  },
  {
    ...
    must: ["gio"],
    w: 3,
    reply: "Cô Út lo mâm cỗ và đặt xe rồi, phần nhà mình là hộp trà sen Phúc Long 165.000đ cho Bà. Đặt hôm nay thì Supra giao kịp 08/08.",
    src: "Ông bà & cô chú",
    goto: "ongba",
    cta: "Mở nhóm Ông bà",
...
const PACK_AUNTY = [
  ...
  },
  {
    ...
    reply: "Phí dã ngoại của Na 120.000đ hạn 08/08, đăng kiểm 340.000đ ngày 12/09, điện tháng 8 khoảng 1.240.000đ đầu tháng sau. Cộng chừng 1.700.000đ trong năm tuần.",
    src: "ví WinMoney",
    flow: "wallet",
    cta: "Mở ví",
  ...
  {
    id: "winx_card",
    k: ["the winx", "ma vach", "quet ma o quay", "tich diem winx", "the thanh vien", "quet the", "ma the winx", "the tich diem"],
    reply: "Thẻ WinX của nhà mình đang 840 điểm, hạng Bạc, còn 160 điểm nữa là lên Vàng. Đưa mã vạch cho nhân viên quầy là tích được ngay.",
    src: "thẻ WinX",
    flow: "winx",
    cta: "Mở thẻ WinX",
    chips: ["Hạng Vàng có gì?", "Điểm WinX được bao nhiêu?", "Voucher đang có gì?"],
  },
  {
    id: "winx_tiers",
    k: ["hang vang co gi", "hang bac", "hang kim cuong", "len hang", "cac hang thanh vien", "hang thanh vien", "bac vang kim cuong", "len hang the nao"],
    reply: "Bạc từ 0 điểm, Vàng từ 1.000, Kim cương từ 5.000. Lên Vàng được voucher 20.000đ mỗi tháng, lên Kim cương là 150.000đ. Trả tiền mặt vẫn quẹt thẻ lấy giá hội viên, chỉ là không cộng điểm.",
    src: "thẻ WinX",
    flow: "winx",
    cta: "Xem thẻ",
    chips: ["Thẻ WinX của tôi", "Voucher đang có gì?", "Điểm WinX được bao nhiêu?"],
  },
  {
    id: "winx_vouchers",
    k: ["voucher", "phieu mua hang", "vi voucher", "voucher dang co gi", "co voucher nao", "phieu giam gia", "doi voucher"],
    reply: "Hạng Bạc đang có phiếu 10.000đ cho đơn từ 100.000đ. Lên Vàng thì mở thêm phiếu 20.000đ và giảm nửa giá ly thứ hai ở Phúc Long.",
    src: "ví voucher",
    flow: "winx",
    cta: "Mở ví voucher",
    chips: ["Hạng Vàng có gì?", "Thẻ WinX của tôi", "Giỏ hàng bao nhiêu tiền?"],
  },
  {
    id: "store_group",
    ...
    flow: "hold",
    cta: "Nhờ chị My chừa",
    chips: ["Chị My là ai?", "Tối nay nấu gì nhanh?", "Giỏ hàng bao nhiêu tiền?"],
  },
  {
    id: "store_staff",
    k: ["chi my la ai", "nhan vien quay tuoi", "nhan vien cua hang", "ai chua hang", "chi my"],
    reply: "Chị My làm quầy tươi ở Win+ 13 Hai Bà Trưng, sáng nào cũng đăng khay giảm giá lên nhóm. Nhắn riêng chị là chị chừa, khỏi phải chạy ra sớm.",
    src: "Win+ Hai Bà Trưng",
    flow: "hold",
    cta: "Nhờ chị My chừa",
    chips: ["Trong nhóm cửa hàng có gì?", "Thịt bò MEATDeli giá sao?", "Giỏ hàng bao nhiêu tiền?"],
  },
  {
    id: "store_discount",
    ...
    flow: "hold",
    cta: "Nhờ chị My chừa",
    chips: ["Chị My là ai?", "Ưu đãi hội viên WinX là gì?", "Tối nay nấu gì nhanh?"],
  },
  {
    id: "member_offer",
    k: ["uu dai hoi vien", "gia hoi vien", "hoi vien winx la gi", "ngay 08 08", "uu dai winx"],
    reply: "Ngày 08/08 WinMart+ có giá hội viên cho người quét thẻ WinX ở quầy, không cần phiếu giấy. Thẻ của nhà mình đang hạng Bạc, quét là được giá luôn.",
    src: "tin cửa hàng",
    flow: "winx",
    cta: "Mở thẻ WinX",
    chips: ["Thẻ WinX của tôi", "Hạng Vàng có gì?", "Có gì giảm giá hôm nay?"],
  },
  {
    id: "ba_health",
    k: ["huyet ap ba", "suc khoe ba", "ba the nao", "ba co khoe khong", "ba dao nay the nao", "huyet ap cua ba", "ba benh gi"],
    reply: "Sáng nay Bà đo 148/92, bảy ngày liền số đi lên. Mai đã gửi hồ sơ cho BS. Hân bên Vinmec xem, còn nó có nghĩa gì thì để bác sĩ nói.",
    src: "BS. Hân · Vinmec",
    flow: "care",
    cta: "Mở hồ sơ Bà",
    chips: ["Bà uống thuốc gì?", "Bà khám lại hôm nào?", "Mua quà gì cho Bà?"],
  },
  {
    id: "ba_medicine",
    k: ["ba uong thuoc gi", "thuoc cua ba", "don thuoc ba", "ba co uong thuoc deu khong", "ba quen uong thuoc"],
    reply: "Bà uống Amlodipine 5mg mỗi sáng, bảy ngày qua uống đều 6 trên 7, quên sáng 04/08. Loa nhà Bà nhắc lúc 07:00. Liều thì bác sĩ giữ nguyên, Mai không đổi.",
    src: "hồ sơ của Bà",
    flow: "care",
    cta: "Mở hồ sơ Bà",
    chips: ["Huyết áp Bà thế nào?", "Bà khám lại hôm nào?", "Loa m.ai làm được gì?"],
  },
  {
    id: "ba_appointment",
    k: ["ba kham lai hom nao", "lich kham cua ba", "bac si han", "kham tu xa", "ba di kham khi nao", "bac si noi gi"],
    reply: "BS. Hân xếp khám từ xa 08:30 ngày 11/08, Bà nói qua loa chứ không phải đi đâu. Bác dặn trên 160 hoặc Bà chóng mặt thì gọi ngay.",
    src: "BS. Hân · Vinmec",
    flow: "care",
    cta: "Xem lịch khám",
    chips: ["Huyết áp Bà thế nào?", "Bà uống thuốc gì?", "Loa m.ai làm được gì?"],
  },
  {
    id: "dangkiem_moto",
