...
const PACK_MONEY = [
  ...
  },
  {
    ...
    not: ["tra xong", "con lai", "sau khi tra"],
    w: 2,
  ...
  },
  {
    ...
    k: ["tra xong con bao nhieu", "con lai bao nhieu", "tra het thi con bao nhieu", "sau khi tra con bao nhieu", "tru het con bao nhieu", "tra xong con lai bao nhieu"],
    must: ["tra xong", "con lai", "sau khi tra", "tru het", "tra het"],
    w: 3,
  ...
  },
  {
    ...
    k: ["tuan nay no gi", "tuan nay phai tra gi", "tuan nay con phai tra gi", "con no gi", "phai dong gi", "con khoan nao chua tra", "tuan nay ton bao nhieu", "no ai cai gi",
        "toi no gi tuan nay", "no gi tuan nay", "con no bao nhieu", "con phai tra gi", "phai tra gi tuan nay",
        "con phai dong gi", "tong cong phai tra bao nhieu", "tuan nay phai tra bao nhieu", "con khoan nao"],
    must: ["tuan nay", "no", "phai tra", "phai dong", "khoan nao", "khoan"],
    w: 2,
  ...
  {
    id: "inspect_fee_money",
    k: ["phi dang kiem", "dang kiem het bao nhieu", "tien dang kiem", "dang kiem bao nhieu tien", "340"],
    must: ["dang kiem", "340"],
    w: 2,
    reply: "Khoảng 340.000đ trả tiền mặt tại trung tâm, chỗ đó chưa nhận chuyển khoản. Việc ngoài hệ nên không cộng điểm WinX, Mai vẫn lo được.",
    src: "hồ sơ xe",
    flow: "inspect",
    cta: "Đặt lịch đăng kiểm",
    chips: ["Đăng kiểm xe khi nào?", "Liệt kê các khoản phải trả", "Số dư còn bao nhiêu?"],
  },
];
...
const PACK_KIDS = [
  ...
  // ————— Na —————
  {
    ...
    k: ["hop phu huynh khi nao", "hop phu huynh na", "hop phu huynh", "khi nao hop phu huynh", "hop phu huynh luc may gio", "hop phu huynh o dau", "15/08", "15 08"],
    must: ["phu huynh", "15/08", "15 08"],
    reply: "Họp phụ huynh của Na lúc 19:00 thứ Bảy 15/08, phòng A2, cô Hồng chủ nhiệm 6A2. Đã vào lịch anh và Vy, nhắc trước một ngày.",
  ...
  {
    id: "gift_ba_tea",
    k: ["mua qua cho ba", "ba thich gi", "qua cho ba", "tra sen", "tra sen phuc long", "mang gi ve gio ong", "qua gio ong", "bieu ba gi"],
    must: ["ba", "tra sen", "qua"],
    reply: "Bà thích trà sen Phúc Long, hộp quà 165.000đ, Supra giao kịp trước thứ Sáu. Mai để sẵn trong nhóm Ông bà cho anh xem.",
    src: "hồ sơ Ông bà",
    goto: "ongba",
    cta: "Xem hộp trà",
    chips: ["Giỗ Ông hôm nào?", "Tuần này có gì?", "Số dư còn bao nhiêu?"],
  },
  ...
  {
    id: "remind_generic",
    k: ["nhac toi", "dat nhac nho", "nho nhac toi", "nhac gium toi", "tao nhac nho", "nhac toi viec nay", "dat lich nhac"],
    must: ["nhac"],
...
const PACK_DOCS = [
  ...
  // ————— LỪA ĐẢO · CUỘC GỌI GIẢ —————
  {
    ...
    k: ["lua dao", "bi lua", "canh giac lua dao", "tranh lua dao", "lua dao qua dien thoai",
        "dau hieu lua dao", "gia mao", "co lua dao khong"],
    must: ["lua", "mao"],
...
const PACK_SHOP = [
  ...
  {
    id: "shop_bokho_items",
    k: ["bo kho can gi", "nguyen lieu bo kho", "mua gi nau bo kho", "bo kho mua gi", "can mua nhung gi", "nguyen lieu can mua", "trong gio co gi", "gio gom nhung gi"],
    reply: "Bò nạm MEATDeli 500g, cà rốt, sả gừng, gói gia vị bò kho Chin-su và 2 ổ bánh mì. Đủ 6 món, Mai chia sẵn theo khẩu phần nhà 4 người.",
    src: "công thức mẹ Su",
    flow: "cart",
    cta: "Mở giỏ",
  ...
  {
    id: "shop_cart_total",
    k: ["gio hang bao nhieu", "tam tinh", "tong gio hang", "gio het bao nhieu", "tong don bao nhieu", "don nay bao nhieu", "het bao nhieu tien", "bao nhieu tien tat ca"],
  ...
  },
  {
    ...
    not: ["dang kiem"],
    reply: "Bò nạm MEATDeli 139.000đ nhỉnh hơn chợ chừng 10.000đ nhưng có nguồn gốc và đổi trả được. Cả giỏ 186.000đ lại cộng 186 điểm nên coi như huề.",
    flow: "cart",
    cta: "Xem từng món",
  ...
  {
    id: "shop_meatdeli",
    k: ["thit mat", "meatdeli", "bo nam", "mua thit", "thit bo", "thit tuoi", "mua thit bo", "thit ngon"],
...
const PACK_LIFE = [
  ...
  {
    id: "mai_vs_assistant",
    k: ["khac tro ly thuong", "khac gi chatgpt", "khac gi google", "khac gi siri", "khac gi cac tro ly khac", "mai khac gi", "tai sao dung mai", "co gi dac biet", "hon cho nao"],
  ...
  // ————— RIÊNG TƯ —————
  {
    ...
    k: ["doc tin nhan", "mai co doc tin nhan cua anh khong", "co doc trom khong", "doc chat cua toi", "co nghe len khong", "co theo doi toi khong", "mai co doc het khong", "co doc zalo khong"],
    w: 2,
  ...
  // ————— CHÀO HỎI · XÃ GIAO —————
  {
    ...
    not: ["chao long"],
    reply: "Chiều anh. Trước 17:00 còn hai việc: học bơi của Bin chưa đóng và chưa chốt ai đón Bin lúc 16:30.",
  ...
  },
  {
    ...
    reply: "Dạ, việc của Mai mà anh. Học bơi của Bin vẫn chưa đóng, hạn 17:00 hôm nay.",
    flow: "pay",
    cta: "Trả 850.000đ",
    chips: ["Ai đón Bin chiều nay?", "Hôm nay còn việc gì gấp?", "Tối nay nhà mình xem gì?"],
  },
  {
    id: "confirm_bare",
  ...
  {
    id: "time_now",
    k: ["may gio roi", "bay gio may gio", "hom nay thu may", "hom nay ngay may", "may gio", "thu may roi", "ngay bao nhieu"],
...
export const FALLBACKS = [
  {
    ...
    chips: ["Trả học bơi cho Bin", "Ai đón Bin chiều nay?", "Hôm nay còn việc gì gấp?"],
  },
  {
    reply: "Câu này Mai chưa nắm, nhưng việc trong nhà thì Mai nắm hết. Sát hạn nhất bây giờ là học bơi của Bin, 17:00 chiều nay.",
    chips: ["Trả học bơi cho Bin", "Đơn dã ngoại của Na", "Số dư WinMoney còn bao nhiêu?"],
  },
  {
  ...
  {
    reply: "Chỗ này Mai chịu, nhưng đừng để lỡ giờ. Chiều nay còn hai mốc: 16:30 Bin tan lớp và 17:00 hạn đóng học bơi.",
    chips: ["Ai đón Bin chiều nay?", "Trả học bơi cho Bin", "Tối nay nấu gì nhanh?"],
  },
  {
...
const PACK_GAPS = [
  ...
  {
    id: "gift_for_ba",
    k: ["mua qua gi cho ba", "qua gi cho ba", "mua gi cho ba", "ba thich gi", "qua cho ba",
        "mua qua gio", "qua gio ong", "bieu ba gi"],
    must: ["ba", "qua"],
    w: 2,
    reply: "Bà thích trà sen Phúc Long, hộp quà 165.000đ, Supra giao kịp thứ Sáu trước giỗ. Mai đặt giúp anh nhé.",
    src: "Ông bà & cô chú",
    goto: "ongba",
    cta: "Mở nhóm Ông bà",
    chips: ["Giỗ Ông hôm nào?", "Tuần này có gì?", "Đặt giỏ WinMart+ tối nay"],
  },
  {
...
export const MAI_INTENTS = [].concat(PACK_MONEY, PACK_KIDS, PACK_DOCS, PACK_SHOP, PACK_LIFE, PACK_GAPS);
